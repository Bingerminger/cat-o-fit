    ...
    },
    {
      ...
      articles: [
        ...
        { q: 'Labor & Ergänzung', body: [
          ...
          { steps: [
            'Beim ersten Öffnen fünf kurze Fragen zur Abgrenzung: Das Modul ist für gesunde Sportlerinnen und Sportler gedacht. Bei Erkrankung, Medikamenten, Schwangerschaft oder Essstörung bleibt es beim reinen Dokumentieren – ohne Empfehlungen.',
            '„+ Wert erfassen": Analyt, Datum, Messwert und Einheit. Vitamin D lässt sich in ng/ml ODER nmol/l eintragen – die App rechnet um.',
            'Antippen zeigt den Verlauf mit beiden Bereichen. Fällt ein Wert über mehrere Messungen, rechnet die App aus, wann er den günstigen Bereich verlässt.',
            'Unter „Ergänzung" stehen Vorschläge mit Begründung, Menge, Zeitpunkt, Obergrenze und Wechselwirkungen – immer zuerst der Weg über die Ernährung.',
            'Was du regelmäßig nimmst, trägst du unter „Dein Plan" ein und hakst es täglich ab.',
          ] },
          { tip: 'Ganz oben schätzt die App deine Energieversorgung: ob du genug isst für das, was du trainierst. Zu wenig Energie ist im Ausdauersport das häufigere Problem als ein fehlendes Präparat – und die Ursache für Leistungsabfall, Verletzungen und Zyklusstörungen.' },
          { p: 'Eisen wird nie ohne Laborwert vorgeschlagen – auf Verdacht eingenommen ist es bei vollen Speichern schädlich. Alle Angaben sind Orientierung, keine Diagnose: Bei auffälligen Werten verweist die App ausdrücklich an eine Ärztin oder einen Arzt. Deine Werte sind privat und für Admins nicht sichtbar.' },
